...
- **Tesseract OCR processing** - Currently assumes ALTO XML already exists
- **Image pre-processing** - Not yet implemented
- **LLM clean text generation** - Currently assumes clean text already exists
